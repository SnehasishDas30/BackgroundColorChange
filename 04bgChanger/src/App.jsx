      ...
      <div className="w-full h-screen duration-300"
       style={{ backgroundColor: color }} >
        ...
        <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
          ...
          <div className="flex flex-wrap justify-center gap-4 shadow-lg bg-gray-400 px-3 py-2 rounded-3xl">
            ...
            className="outline-none px-4 py-1 rounded-2xl text-white shadow-lg" style={{ backgroundColor: "magenta" }}>magenta</button>
